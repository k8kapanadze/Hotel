 ...
 <body class="h-full bg-gradient-to-br from-slate-50 via-white to-blue-50 overflow-auto">
  <div class="w-full min-h-full"><!-- Navigation -->
   <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/80 backdrop-blur-xl border-b border-slate-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="flex justify-between items-center h-20"><a href="#home" class="flex items-center space-x-2">
       <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center"><span class="text-white font-bold text-xl">I</span>
       </div><span class="text-2xl font-bold text-slate-800">IDENTISITE</span> </a> <!-- Desktop Navigation -->
      <div class="hidden lg:flex items-center space-x-8"><a href="#home" class="nav-link text-slate-600 hover:text-blue-600 transition-colors font-medium" data-lang="ka">მთავარი</a> <a href="#about" class="nav-link text-slate-600 hover:text-blue-600 transition-colors font-medium" data-lang="ka">ჩვენ შესახებ</a> <a href="#services" class="nav-link text-slate-600 hover:text-blue-600 transition-colors font-medium" data-lang="ka">სერვისები</a> <a href="#portfolio" class="nav-link text-slate-600 hover:text-blue-600 transition-colors font-medium" data-lang="ka">პორტფოლიო</a> <a href="#process" class="nav-link text-slate-600 hover:text-blue-600 transition-colors font-medium" data-lang="ka">პროცესი</a> <a href="#blog" class="nav-link text-slate-600 hover:text-blue-600 transition-colors font-medium" data-lang="ka">ბლოგი</a> <a href="#contact" class="nav-link text-slate-600 hover:text-blue-600 transition-colors font-medium" data-lang="ka">კონტაქტი</a>
      </div>
      <div class="flex items-center space-x-4"><!-- Language Switcher --> <button id="langSwitch" class="px-3 py-1.5 text-sm font-medium text-slate-600 hover:text-blue-600 border border-slate-200 rounded-lg hover:border-blue-300 transition-all"> EN </button> <a href="#contact" class="hidden sm:inline-flex px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-105"> <span data-lang="ka">დავიწყოთ</span> </a> <!-- Mobile Menu Button --> <button id="mobileMenuBtn" class="lg:hidden p-2 text-slate-600 hover:text-blue-600">
     ...
     <div id="mobileMenu" class="lg:hidden hidden pb-4">
      <div class="flex flex-col space-y-3"><a href="#home" class="text-slate-600 hover:text-blue-600 py-2 font-medium" data-lang="ka">მთავარი</a> <a href="#about" class="text-slate-600 hover:text-blue-600 py-2 font-medium" data-lang="ka">ჩვენ შესახებ</a> <a href="#services" class="text-slate-600 hover:text-blue-600 py-2 font-medium" data-lang="ka">სერვისები</a> <a href="#portfolio" class="text-slate-600 hover:text-blue-600 py-2 font-medium" data-lang="ka">პორტფოლიო</a> <a href="#process" class="text-slate-600 hover:text-blue-600 py-2 font-medium" data-lang="ka">პროცესი</a> <a href="#blog" class="text-slate-600 hover:text-blue-600 py-2 font-medium" data-lang="ka">ბლოგი</a> <a href="#contact" class="text-slate-600 hover:text-blue-600 py-2 font-medium" data-lang="ka">კონტაქტი</a>
      </div>
     </div>
    </div>
   </nav><!-- Hero Section -->
   <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20"><!-- Background Blobs -->
    <div class="blob w-96 h-96 bg-blue-300 top-20 -left-48 animate-float"></div>
    <div class="blob w-80 h-80 bg-blue-200 bottom-20 -right-40 animate-float" style="animation-delay: -3s;"></div>
    <div class="blob w-64 h-64 bg-blue-100 top-1/2 left-1/3 animate-float" style="animation-delay: -1.5s;"></div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
     <div class="grid lg:grid-cols-2 gap-12 items-center">
      <div class="text-center lg:text-left">
       <div class="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-6 animate-fade-in-up"><span class="w-2 h-2 bg-blue-500 rounded-full mr-2 animate-pulse"></span> <span data-lang="ka">პრემიუმ ვებ სააგენტო</span>
       </div>
       ...
       <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up stagger-3"><a href="#contact" class="px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold rounded-xl hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-105 text-center"> <span data-lang="ka">დავიწყოთ პროექტი</span> </a> <a href="#portfolio" class="px-8 py-4 bg-white text-slate-700 font-semibold rounded-xl border-2 border-slate-200 hover:border-blue-300 hover:text-blue-600 transition-all duration-300 text-center"> <span data-lang="ka">ვნახოთ ნამუშევრები</span> </a>
       </div><!-- Stats -->
       ...
       <div class="relative w-full h-96"><!-- Floating Cards -->
        ...
        <div class="absolute top-20 right-0 w-56 h-48 glass-card rounded-2xl p-4 animate-float shadow-xl" style="animation-delay: -2s;">
         <div class="text-center">
          <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl mx-auto mb-3 flex items-center justify-center">
   ...
   <section id="about" class="py-24 bg-gradient-to-b from-white to-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="text-center mb-16"><span class="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4" data-lang="ka">ჩვენ შესახებ</span>
     ...
     <div class="grid lg:grid-cols-2 gap-16 items-center mb-20">
      ...
      <div class="relative">
       <div class="bg-gradient-to-br from-blue-500 to-blue-700 rounded-3xl p-8 text-white">
     ...
     <div class="mt-20">
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
       <div class="text-center group">
        <div class="w-32 h-32 mx-auto mb-4 bg-gradient-to-br from-indigo-400 to-blue-600 rounded-2xl flex items-center justify-center text-4xl text-white font-bold group-hover:scale-105 transition-transform">
         გ.კ
        </div>
       ...
       <div class="text-center group">
        <div class="w-32 h-32 mx-auto mb-4 bg-gradient-to-br from-blue-500 to-pink-500 rounded-2xl flex items-center justify-center text-4xl text-white font-bold group-hover:scale-105 transition-transform">
         ნ.ბ
        </div>
   ...
   <section id="services" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="text-center mb-16"><span class="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4" data-lang="ka">სერვისები</span>
     ...
     <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8"><!-- Service 1 -->
      <div class="group p-8 bg-gradient-to-b from-slate-50 to-white rounded-3xl border border-slate-100 hover-lift">
       ...
       </ul><a href="#contact" class="inline-flex items-center text-blue-600 font-medium hover:text-blue-700"> <span data-lang="ka">შეკვეთა</span>
        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewbox="0 0 24 24">
         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
        </svg></a>
      </div><!-- Service 2 -->
      <div class="group p-8 bg-gradient-to-b from-slate-50 to-white rounded-3xl border border-slate-100 hover-lift">
       <div class="w-14 h-14 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
   ...
   <section class="py-24 bg-gradient-to-b from-blue-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="text-center mb-16"><span class="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4" data-lang="ka">რატომ ჩვენ</span>
   ...
   <section id="portfolio" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="text-center mb-16"><span class="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4" data-lang="ka">პორტფოლიო</span>
     ...
     <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8"><!-- Project 1 -->
      <div class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 to-blue-700 aspect-[4/3] hover-lift cursor-pointer">
      ...
      <div class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-500 to-blue-700 aspect-[4/3] hover-lift cursor-pointer">
       <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
       <div class="absolute inset-0 flex flex-col justify-end p-6 text-white translate-y-8 group-hover:translate-y-0 transition-transform duration-300">
   ...
   <section id="process" class="py-24 bg-gradient-to-b from-slate-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="text-center mb-16"><span class="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4" data-lang="ka">პროცესი</span>
     ...
     <div class="relative"><!-- Timeline Line -->
      <div class="hidden lg:block absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-500 to-blue-700 transform -translate-x-1/2"></div>
      <div class="space-y-12 lg:space-y-0"><!-- Step 1 -->
       <div class="relative lg:grid lg:grid-cols-2 lg:gap-16 items-center lg:pb-20">
        <div class="lg:text-right lg:pr-16">
         <div class="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-full font-bold text-lg mb-4 lg:hidden">
          1
         </div>
        ...
        <div class="hidden lg:flex items-center justify-start pl-16">
         <div class="absolute left-1/2 transform -translate-x-1/2 w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-full flex items-center justify-center font-bold text-lg z-10">
          1
         </div>
        </div>
       </div><!-- Step 2 -->
   ...
   <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="text-center mb-16"><span class="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4" data-lang="ka">შეფასებები</span>
     ...
     <div class="grid md:grid-cols-3 gap-8">
      <div class="p-8 bg-gradient-to-b from-slate-50 to-white rounded-3xl border border-slate-100">
       ...
       <div class="flex items-center">
        <div class="w-12 h-12 bg-gradient-to-br from-indigo-400 to-blue-600 rounded-full flex items-center justify-center text-white font-bold">
         ლ.გ
        </div>
        <div class="ml-4">
   ...
   <section id="blog" class="py-24 bg-gradient-to-b from-slate-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="text-center mb-16"><span class="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4" data-lang="ka">ბლოგი</span>
     ...
     <div class="grid md:grid-cols-3 gap-8">
      <article class="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover-lift">
       <div class="aspect-video bg-gradient-to-br from-blue-500 to-blue-700"></div>
       <div class="p-6">
        ...
        <h3 class="text-lg font-bold text-slate-800 mb-2 group-hover:text-blue-600 transition-colors" data-lang="ka">2024 წლის ვებ დიზაინის ტრენდები</h3>
        <p class="text-slate-600 text-sm mb-4" data-lang="ka">რა ტენდენციები განსაზღვრავს ვებ დიზაინის მომავალს და როგორ გამოიყენოთ ისინი...</p><a href="#" class="inline-flex items-center text-blue-600 font-medium text-sm hover:text-blue-700"> <span data-lang="ka">წაიკითხე მეტი</span>
         <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewbox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
         </svg></a>
       </div>
      ...
      <article class="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover-lift">
       ...
       <div class="p-6">
        ...
        <h3 class="text-lg font-bold text-slate-800 mb-2 group-hover:text-blue-600 transition-colors" data-lang="ka">SEO ოპტიმიზაციის საფუძვლები</h3>
        <p class="text-slate-600 text-sm mb-4" data-lang="ka">როგორ გააუმჯობესოთ თქვენი ვებსაიტის პოზიციები Google-ში...</p><a href="#" class="inline-flex items-center text-blue-600 font-medium text-sm hover:text-blue-700"> <span data-lang="ka">წაიკითხე მეტი</span>
         <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewbox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
         </svg></a>
       </div>
      ...
      <article class="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover-lift">
       ...
       <div class="p-6">
        ...
        <h3 class="text-lg font-bold text-slate-800 mb-2 group-hover:text-blue-600 transition-colors" data-lang="ka">E-commerce წარმატების საიდუმლო</h3>
        <p class="text-slate-600 text-sm mb-4" data-lang="ka">რა ფაქტორები განსაზღვრავს ონლაინ მაღაზიის წარმატებას...</p><a href="#" class="inline-flex items-center text-blue-600 font-medium text-sm hover:text-blue-700"> <span data-lang="ka">წაიკითხე მეტი</span>
         <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewbox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
         </svg></a>
       </div>
   ...
   <section id="contact" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="text-center mb-16"><span class="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4" data-lang="ka">კონტაქტი</span>
     ...
     <div class="grid lg:grid-cols-2 gap-16"><!-- Contact Form -->
      ...
      <div class="space-y-8">
       <div class="p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl">
        <div class="flex items-start space-x-4">
         ...
         <div>
          ...
          <p id="contactEmailDisplay" class="text-slate-600"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="335a5d555c735a57565d475a405a47561d5456">[email&#160;protected]</a></p>
         </div>
        </div>
       </div>
       ...
       <div class="flex space-x-4"><a href="#" class="w-12 h-12 bg-slate-100 hover:bg-blue-100 rounded-xl flex items-center justify-center text-slate-600 hover:text-blue-600 transition-all">
         <svg class="w-5 h-5" fill="currentColor" viewbox="0 0 24 24">
          <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
         </svg></a> <a href="#" class="w-12 h-12 bg-slate-100 hover:bg-blue-100 rounded-xl flex items-center justify-center text-slate-600 hover:text-blue-600 transition-all">
         <svg class="w-5 h-5" fill="currentColor" viewbox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="grid md:grid-cols-4 gap-12 mb-12">
      ...
      <div>
       ...
       <ul class="space-y-2 text-slate-400 text-sm">
        <li><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="61080f070e210805040f1508120815044f0604">[email&#160;protected]</a></li>
