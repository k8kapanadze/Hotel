...
<html lang="ka" class="h-full">
 <head>
  ...
  <meta name="description" content="IDENTISITE - იდენტობა რომელიც საიტად იქცევა. პრემიუმ ვებსაიტების დამზადება.">
  ...
  <nav class="fixed top-0 w-full z-50 dark-glass border-b border-white/5">
    <div class="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
      ...
      <div class="hidden md:flex space-x-8 text-sm font-medium text-slate-400">
        <a href="#home" class="hover:text-sky-400 transition-colors">მთავარი</a>
        <a href="#about" class="hover:text-sky-400 transition-colors">ჩვენ შესახებ</a>
        <a href="#services" class="hover:text-sky-400 transition-colors">სერვისები</a>
        <a href="#contact" class="hover:text-sky-400 transition-colors">კონტაქტი</a>
      </div>
